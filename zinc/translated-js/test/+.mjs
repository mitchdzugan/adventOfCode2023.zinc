import * as _PLUS_ from './__test_utils__/+.mjs';var TestProd = -1
;
...
expect(_PLUS_.encode(_PLUS_.KeyedList([[1, 2], [3, 4]])))["to_eq"](_PLUS_.str("[", _PLUS_.KeyedListT, ",[1,2],[3,4]]"));
expect(_PLUS_.encode(_PLUS_.Map([[1, 2], [3, 4]])))["to_eq"](_PLUS_.str("[", _PLUS_.MapT, ",[1,2],[3,4]]"));
expect(_PLUS_.encode(_PLUS_.KeyMap([[Tag, 2], [Data(3), 4]])))["to_eq"](_PLUS_.str("[", _PLUS_.KeyMapT, ",[[", TestSum, ",", TagT, "],2],", "[[", TestSum, ",", DataT, ",3],4]]"));
...
expect(_PLUS_.keys(_PLUS_.Map([[4, "a"], [5, "b"], [6, "c"]])))["to_eq"](_PLUS_.Vec(4, 5, 6));
...
expect(_PLUS_.vals(_PLUS_.Map([[4, "a"], [5, "b"], [6, "c"]])))["to_eq"](_PLUS_.Vec("a", "b", "c"));
...
expect(_PLUS_.fmap(_PLUS_.inc, _PLUS_.Map([[4, 8], [15, 16]])))["to_eq"](_PLUS_.Map([[4, 9], [15, 17]]));
...
expect(fmapper16(_PLUS_.Map([[7, 0], [8, 1], [9, 2]])))["to_eq"](_PLUS_.Map([[7, _PLUS_.Vec(1, 7, 3)], [8, _PLUS_.Vec(2, 8, 3)], [9, _PLUS_.Vec(3, 9, 3)]]));
...
export { mkTestProd, TestProd, TestSum, TagT, DataT, Sugar, Writer, WriterT, Data, Tag, testKey }
