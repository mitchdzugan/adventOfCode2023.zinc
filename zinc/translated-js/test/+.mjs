...
describe("core data library '+'", (function() {
    ...
    describe("fmap", (function() {
        ...
        return it("passes all args", (function() {
            let fmapper16 = (function(coll) {
                return _PLUS_.fmap((function(_anon_PERCENT_1_4, _anon_PERCENT_2_5, _anon_PERCENT_3_6) {
                    return _PLUS_.Vec(_PLUS_.inc(_anon_PERCENT_1_4), _anon_PERCENT_2_5, _PLUS_.size(_anon_PERCENT_3_6));
                }), coll);
            });
    ...
    return describe("filter/remove", (function() {
        it("filters collection by predicate", (function() {
            ...
            expect(_PLUS_.filter((function(_anon_PERCENT_1_8) {
                return (_anon_PERCENT_1_8 > 2);
            }), _PLUS_.Just(5)))["to_eq"](_PLUS_.Just(5));
            expect(_PLUS_.filter((function(_anon_PERCENT_1_9) {
                return (_anon_PERCENT_1_9 > 2);
            }), _PLUS_.Just(1)))["to_eq"](_PLUS_.None);
            expect(_PLUS_.filter((function(_anon_PERCENT_1_10) {
                return (_anon_PERCENT_1_10 > 2);
            }), _PLUS_.None))["to_eq"](_PLUS_.None);
            expect(_PLUS_.remove((function(_anon_PERCENT_1_11) {
                return (_anon_PERCENT_1_11 > 2);
            }), _PLUS_.Vec(3, 1, 4, 5, 2)))["to_eq"](_PLUS_.Vec(1, 2));
            expect(_PLUS_.remove((function(_anon_PERCENT_1_12) {
                return (_anon_PERCENT_1_12 > 2);
            }), _PLUS_.Just(5)))["to_eq"](_PLUS_.None);
            expect(_PLUS_.remove((function(_anon_PERCENT_1_13) {
                return (_anon_PERCENT_1_13 > 2);
            }), _PLUS_.Just(1)))["to_eq"](_PLUS_.Just(1));
            return expect(_PLUS_.filter((function(_anon_PERCENT_1_14) {
                return (_anon_PERCENT_1_14 > 2);
            }), _PLUS_.None))["to_eq"](_PLUS_.None);
        }));
        return it("passes all args", (function() {
            let filterer17 = _PLUS_.partial(_PLUS_.filter, (function(_anon_PERCENT_1_15, _anon_PERCENT_2_16, _anon_PERCENT_3_17) {
                return _PLUS_.is(0, _PLUS_.mod((_anon_PERCENT_1_15 + _anon_PERCENT_2_16 + _PLUS_.size(_anon_PERCENT_3_17)), 2));
            }));
