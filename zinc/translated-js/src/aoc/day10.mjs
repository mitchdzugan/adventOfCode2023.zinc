...
var make_loop_only_assuming = (function(base, s_char) {
    let loop_only45 = _PLUS_.fmap((function(_anon_PERCENT_1_20) {
        return _PLUS_.fmap((function() {
            return ".";
        }), _anon_PERCENT_1_20);
    }), base);
    let init_pos46 = get_initial_pos(base);
    let mk_inst47 = (function(_anon_PERCENT_1_21) {
        return Inst(_anon_PERCENT_1_21, init_pos46, init_dir(s_char), init_pos46, s_char);
    });
...
var make_loop_only = (function(base) {
    return _PLUS_.unwrap_BANG_(_PLUS_.reduce((function(_anon_PERCENT_1_23, _anon_PERCENT_2_22) {
        return _PLUS_.or_((function() {
            return try_s_char(base, _anon_PERCENT_2_22);
        }), _PLUS_.fmap(_PLUS_.Just, _anon_PERCENT_1_23));
    }), _PLUS_.None, _PLUS_.Vec("-", "|", "J", "L", "F", "7")));
});
var to_matrix = (function(input) {
    return _PLUS_.fmap((function(_anon_PERCENT_1_24) {
        return lib.strsplit(_anon_PERCENT_1_24, "");
    }), lib.strsplit(input, "\n"));
});
...
var part1 = (function(input) {
    ...
    })(_PLUS_.remove((function(_anon_PERCENT_1_25) {
        return _PLUS_.is(".", _anon_PERCENT_1_25);
    }), _PLUS_.bind(_PLUS_.id, m66)));
});
let crossings_to_top_edge_impl_3367 = (function(m, x, y) {
    let getc68 = (function(_anon_PERCENT_1_26) {
        return get_at_pos(m, Pos(x, _anon_PERCENT_1_26));
    });
    let plain_QMARK_69 = (function(_anon_PERCENT_1_27) {
        return _PLUS_.is(getc68(_anon_PERCENT_1_27), ".");
    });
    let edge_QMARK_70 = (function(_anon_PERCENT_1_28) {
        return (_PLUS_.is(getc68(_anon_PERCENT_1_28), "-") || _PLUS_.is(getc68(_anon_PERCENT_1_28), "|"));
    });
    let corner_QMARK_71 = (function(_anon_PERCENT_1_29) {
        return (!edge_QMARK_70(_anon_PERCENT_1_29) && !plain_QMARK_69(getc68(_anon_PERCENT_1_29)));
    });
    let get_rest72 = (function(_anon_PERCENT_1_30) {
        return crossings_to_top_edge(m, x, (_anon_PERCENT_1_30 - 1));
    });
    if ((y < 0)) {
        return 0;
    } else {
        if (plain_QMARK_69(y)) {
            ...
            if (edge_QMARK_70(y)) {
                return (1 + get_rest72(y));
            } else {
                if ("else") {
                    let suby73 = (y - 1);
                    while (true) {
                        if (edge_QMARK_70(suby73)) {
                            let G__74 = (suby73 - 1);
                            suby73 = G__74;
                            continue;
                        } else {
                            return (get_rest72(suby73) + (((next_dir(getc68(y), Down) === next_dir(getc68(suby73), Up))) ? (0) : (1)));
                        };
                        break;
                    }
                } else {
...
let crossings_to_top_edge_memo_3575 = _PLUS_.Map();
var crossings_to_top_edge = (function() {
    let f76 = (function(var_args) {
        let args7780 = [];
        let len__24440__auto__81 = arguments["length"];
        let i7882 = 0;
        while (true) {
            if ((i7882 < len__24440__auto__81)) {
                args7780.push((arguments[i7882]));
                let G__83 = (i7882 + 1);
                i7882 = G__83;
                continue;
            };
        ...
        let argseq__24702__auto__84 = (((0 < args7780["length"])) ? (args7780.slice(0)) : (undefined));
        return f76.cljs$core$IFn$_invoke$arity$variadic(argseq__24702__auto__84);
    });
    f76["cljs$core$IFn$_invoke$arity$variadic"] = (function(crossings_to_top_edge_args_34) {
        let crossings_to_top_edge_mkey_3285 = _PLUS_.encode(_PLUS_.fmap(_PLUS_.forcedKey, _PLUS_.apply(_PLUS_.Vec, crossings_to_top_edge_args_34)));
        let crossings_to_top_edge_rtrn_3186 = _PLUS_.or_((function() {
            return _PLUS_.apply(crossings_to_top_edge_impl_3367, crossings_to_top_edge_args_34);
        }), _PLUS_.at(crossings_to_top_edge_memo_3575, crossings_to_top_edge_mkey_3285));
        _PLUS_.put(crossings_to_top_edge_memo_3575, crossings_to_top_edge_mkey_3285, crossings_to_top_edge_rtrn_3186);
        return crossings_to_top_edge_rtrn_3186;
    });
    f76["cljs$lang$maxFixedArity"] = 0;
    f76["cljs$lang$applyTo"] = (function(seq79) {
        let self__24463__auto__87 = this;
        return self__24463__auto__87.cljs$core$IFn$_invoke$arity$variadic(seq(seq79));
    });
    return f76;
})();
var enclosed_QMARK_ = (function(m, val_145) {
    let var_x_14688 = val_145[1];
    let var_y_14789 = val_145[2];
    return (("." === get_at_pos(m, val_145)) && (1 === _PLUS_.mod(crossings_to_top_edge(m, var_x_14688, var_y_14789), 2)));
});
var part2 = (function(input) {
    let m90 = parse_into_matrix_with_loop_only(input);
    return _PLUS_.reduce((function(_anon_PERCENT_1_33, _anon_PERCENT_2_34) {
        return (_anon_PERCENT_1_33 + _PLUS_.size(_anon_PERCENT_2_34));
    }), 0, _PLUS_.fmap((function(row, y) {
        return _PLUS_.filter((function(_anon_PERCENT_1_32, _anon_PERCENT_2_31) {
            return enclosed_QMARK_(m90, Pos(_anon_PERCENT_2_31, y));
        }), row);
    }), m90));
});
