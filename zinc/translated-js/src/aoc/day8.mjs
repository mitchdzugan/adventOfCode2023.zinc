...
var parseNav = (function(line) {
    return _PLUS_.bind((function(_anon_PERCENT_1_54) {
        if ((_anon_PERCENT_1_54 === "L")) {
            return _PLUS_.Vec(Left);
        } else {
            if ((_anon_PERCENT_1_54 === "R")) {
...
var parseInput = (function(input) {
    ...
    let nodes24 = _PLUS_.keyBy((function(val_62) {
        ...
        return var_id_6325;
    }), _PLUS_.fmap(parseLine, _PLUS_.filter((function(_anon_PERCENT_1_55) {
        return _anon_PERCENT_1_55.includes("=");
    }), lines21)));
