...
_PLUS_.each((function (_anon_PERCENT_1_32) {
return addColorValFromColorStr(colorVals13, _anon_PERCENT_1_32);
}), colorStrs14);
...
return (_anon_PERCENT_1_33 && valid_round_QMARK_(_anon_PERCENT_2_34));
}), true, var_rounds_3436);
})
;
var to_games = (function (input) {
return _PLUS_.fmap(parse_game, _PLUS_.filter((function (_anon_PERCENT_1_35) {
...
return _PLUS_.reduce((function (_anon_PERCENT_1_38, _anon_PERCENT_2_39) {
return (_anon_PERCENT_1_38 + _anon_PERCENT_2_39);
