...
var digitStrLengths = (function() {
    ...
    _PLUS_.each((function(_anon_PERCENT_1_46, _anon_PERCENT_2_45) {
        return _PLUS_.put(seenLengths1, _anon_PERCENT_2_45["length"], true);
    }), digitStrs);
...
var getCalibrationSum = (function(input, useDigitStrs) {
    return _PLUS_.reduce((function(_anon_PERCENT_1_52, _anon_PERCENT_2_53) {
        return (_anon_PERCENT_1_52 + _PLUS_.or(0, _anon_PERCENT_2_53));
    }), 0, _PLUS_.fmap((function(_anon_PERCENT_1_51) {
        return getCalibrationValue(_anon_PERCENT_1_51, useDigitStrs);
    }), lib.strsplit(input, "\n")));
});
