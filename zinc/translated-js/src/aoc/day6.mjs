...
var count_possibilities = (function(val_79) {
    let var_time_801 = val_79[1];
    let var_record_812 = val_79[2];
    let qdrtc_root3 = (Math.sqrt(((var_time_801 * var_time_801) - (4 * var_record_812))) / 2);
    let qdrtc_b_2a4 = (var_time_801 / 2);
