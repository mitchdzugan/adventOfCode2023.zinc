...
return parse_initial_seeds(line);} else {
if (line.trim().endsWith("map:")) {
return parse_map_header(line);} else {
if ("else") {
return parse_map_entry(line);} else {
return undefined;}}}}
})
;
let get_guide_ind_impl_2334 = (function (id, guides) {
let get_id35 = (function (_anon_PERCENT_1_90) {
return guide_id(_PLUS_.at_BANG_(guides, _anon_PERCENT_1_90));
});
let lbound36 = 0;
let rbound37 = (_PLUS_.size(guides) - 1);
while(true){
if ((id < get_id35(lbound36))) {
return _PLUS_.None;} else {
if ((id >= get_id35(rbound37))) {
return _PLUS_.Just(rbound37);} else {
if (((rbound37 - lbound36) <= 1)) {
return _PLUS_.Just(lbound36);} else {
if ("else") {
let mbound38 = (lbound36 + _PLUS_.floor(((rbound37 - lbound36) / 2)));
if (_PLUS_.is(id, get_id35(mbound38))) {
return _PLUS_.Just(mbound38);} else {
...
return _PLUS_.or(0, _PLUS_.fmap((function (_anon_PERCENT_1_91) {
return offset(_PLUS_.at_BANG_(guides, _anon_PERCENT_1_91));
...
let mk_range60 = (function (_anon_PERCENT_1_92, _anon_PERCENT_2_93) {
return Range(dst59, _anon_PERCENT_1_92, _anon_PERCENT_2_93);
});
let get_id61 = (function (_anon_PERCENT_1_94) {
return guide_id(_PLUS_.at_BANG_(cat_guides58, _anon_PERCENT_1_94));
});
let get_offset62 = (function (_anon_PERCENT_1_95) {
return offset(_PLUS_.at_BANG_(cat_guides58, _anon_PERCENT_1_95));
});
let results63 = _PLUS_.Vec();
let end64 = (start + length);
let oob_QMARK_65 = (function (_anon_PERCENT_1_96) {
return (_anon_PERCENT_1_96 >= end64);
});
let id66 = start;
...
_PLUS_.push(results63, mk_range60((id66 + off68), (end64 - id66)))} else {
...
let rsrc82 = {r:""};
let rmap83 = {r:_PLUS_.Map()};
let rinitials84 = {r:_PLUS_.Vec()};
...
return _PLUS_.each((function (_anon_PERCENT_1_99) {
return push_guide(cat_map, _anon_PERCENT_1_99);
}), _PLUS_.sort_by(guide_id, _PLUS_.vals(_PLUS_.fmap((function (_anon_PERCENT_1_98, _anon_PERCENT_2_97) {
return Guide(_anon_PERCENT_2_97, _anon_PERCENT_1_98);
}), rmap83["r"]))));
...
export { parse_map_header, init_category_map, InitialT, destination, offset, GuideT, min_location_for_input, guide_id, parse_map_entry, part2, parse_initial_seeds, Range, parse_input, part1, InputData, InputDataT, get_associated_item, push_guide, get_offset, get_location, get_guide_ind, InputLineT, min_location, parse_line, CategoryMapT, guides, Item, get_associated_ranges, Guide }
