...
_PLUS_.qt_store[14] = "InputDataT";
_PLUS_.bury(_PLUS_.prop_store, [14, undefined], ({
    0: ({
        "idname": "initials",
        "fullname": "%initials",
        "ind": 0
    ...
    1: ({
        "idname": "category-maps",
        "fullname": "%category-maps",
        "ind": 1
    })
}));
var InputDataT = 14;
...
_PLUS_.qt_store[15] = "GuideT";
_PLUS_.bury(_PLUS_.prop_store, [15, undefined], ({
    0: ({
        "idname": "id",
        "fullname": "%id",
        "ind": 0
...
_PLUS_.qt_store[16] = "InitialT";
_PLUS_.bury(_PLUS_.prop_store, [16, 1], ({
    0: ({
        "idname": "+",
        "fullname": "%+",
        "ind": 0
...
_PLUS_.bury(_PLUS_.prop_store, [16, 2], ({
    0: ({
        "idname": "+",
        "fullname": "%+",
        "ind": 0
...
_PLUS_.bury(_PLUS_.variant_store, [16, 1], "Item");
_PLUS_.bury(_PLUS_.variant_store, [16, 2], "Range");
var InitialT = 16;
...
_PLUS_.qt_store[17] = "CategoryMapT";
_PLUS_.bury(_PLUS_.prop_store, [17, undefined], ({
    0: ({
        "idname": "src",
        "fullname": "%src",
        "ind": 0
...
_PLUS_.qt_store[18] = "InputLineT";
_PLUS_.bury(_PLUS_.prop_store, [18, 1], ({
    0: ({
        "idname": "+",
        "fullname": "%+",
        "ind": 0
...
_PLUS_.bury(_PLUS_.prop_store, [18, 2], ({
    0: ({
        "idname": "+",
        "fullname": "%+",
        "ind": 0
    ...
    1: ({
        ...
        "fullname": "%seeds",
        "ind": 1,
        "type": [_PLUS_.VecT, _PLUS_.NumT]
    })
}));
_PLUS_.bury(_PLUS_.prop_store, [18, 3], ({
    0: ({
        "idname": "+",
        "fullname": "%+",
        "ind": 0
...
_PLUS_.bury(_PLUS_.prop_store, [18, 4], ({
    0: ({
        "idname": "+",
        "fullname": "%+",
        "ind": 0
...
_PLUS_.bury(_PLUS_.variant_store, [18, 1], "Noop");
_PLUS_.bury(_PLUS_.variant_store, [18, 2], "InitialSeeds");
_PLUS_.bury(_PLUS_.variant_store, [18, 3], "MapHeader");
_PLUS_.bury(_PLUS_.variant_store, [18, 4], "MapEntry");
var InputLineT = 18;
...
let get_guide_ind_impl_2334 = (function(id, guides) {
    let get_id35 = (function(_anon_PERCENT_1_98) {
        return guide_id(_PLUS_.at_BANG_(guides, _anon_PERCENT_1_98));
    });
    let lbound36 = 0;
...
var get_offset = (function(id, guides) {
    return _PLUS_.or(0, _PLUS_.fmap((function(_anon_PERCENT_1_99) {
        return offset(_PLUS_.at_BANG_(guides, _anon_PERCENT_1_99));
...
var get_associated_ranges = (function(category_maps, category, start, length) {
    ...
    let mk_range60 = (function(_anon_PERCENT_1_100, _anon_PERCENT_2_101) {
        return Range(dst59, _anon_PERCENT_1_100, _anon_PERCENT_2_101);
    });
    let get_id61 = (function(_anon_PERCENT_1_102) {
        return guide_id(_PLUS_.at_BANG_(cat_guides58, _anon_PERCENT_1_102));
    });
    let get_offset62 = (function(_anon_PERCENT_1_103) {
        return offset(_PLUS_.at_BANG_(cat_guides58, _anon_PERCENT_1_103));
    });
    let results63 = _PLUS_.Vec();
    let end64 = (start + length);
    let oob_QMARK_65 = (function(_anon_PERCENT_1_104) {
        return (_anon_PERCENT_1_104 >= end64);
    });
    let id66 = start;
...
var parse_input = (function(input, ranges_QMARK_) {
    ...
    let finalize_category_map87 = (function() {
        _PLUS_.each((function(cat_map) {
            return _PLUS_.each((function(_anon_PERCENT_1_107) {
                return push_guide(cat_map, _anon_PERCENT_1_107);
            }), _PLUS_.sort_by(guide_id, _PLUS_.vals(_PLUS_.fmap((function(_anon_PERCENT_1_106, _anon_PERCENT_2_105) {
                return Guide(_anon_PERCENT_2_105, _anon_PERCENT_1_106);
            }), rmap83["r"]))));
