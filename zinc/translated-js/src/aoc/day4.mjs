...
var parseCards = (function(input) {
    return _PLUS_.fmap(parseCard, _PLUS_.filter((function(_anon_PERCENT_1_66) {
        return !_PLUS_.is("", _anon_PERCENT_1_66.trim());
    }), lib.strsplit(input, "\n")));
});
var part1 = (function(input) {
    return _PLUS_.reduce((function(_anon_PERCENT_1_67, _anon_PERCENT_2_68) {
        return (_anon_PERCENT_1_67 + _anon_PERCENT_2_68);
    }), 0, _PLUS_.fmap(cardValue, parseCards(input)));
});
var scratchCardsWonByCard = (function(card, cardsById) {
    return _PLUS_.reduce((function(_anon_PERCENT_1_70, _anon_PERCENT_2_71) {
        return (_anon_PERCENT_1_70 + _anon_PERCENT_2_71);
    }), 1, _PLUS_.fmap((function(_anon_PERCENT_1_69) {
        return scratchCardsWonById((cardId(card) + 1 + _anon_PERCENT_1_69), cardsById);
    }), _PLUS_.Range(myWinCount(card))));
});
let scratchCardsWonById_impl_1829 = (function(id, cardsById) {
    return _PLUS_.or(0, _PLUS_.fmap((function(_anon_PERCENT_1_72) {
        return scratchCardsWonByCard(_anon_PERCENT_1_72, cardsById);
...
var part2 = (function(input) {
    ...
    }), 0, _PLUS_.fmap((function(_anon_PERCENT_1_73) {
        return scratchCardsWonById(_anon_PERCENT_1_73, cardsById44);
