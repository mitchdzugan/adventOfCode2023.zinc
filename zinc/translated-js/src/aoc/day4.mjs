...
var parseCards = (function(input) {
    return _PLUS_.fmap(parseCard, _PLUS_.filter((function(_anon_PERCENT_1_25) {
        return !_PLUS_.is("", _anon_PERCENT_1_25.trim());
    }), lib.strsplit(input, "\n")));
});
...
var scratchCardsWonByCard = (function(card, cardsById) {
    ...
    }), 1, _PLUS_.fmap((function(_anon_PERCENT_1_28) {
        return scratchCardsWonById((cardId(card) + 1 + _anon_PERCENT_1_28), cardsById);
    }), _PLUS_.Range(myWinCount(card))));
});
let scratchCardsWonById_impl_1829 = (function(id, cardsById) {
    return _PLUS_.or(0, _PLUS_.fmap((function(_anon_PERCENT_1_31) {
        return scratchCardsWonByCard(_anon_PERCENT_1_31, cardsById);
...
var part2 = (function(input) {
    ...
    return _PLUS_.reduce((function(_anon_PERCENT_1_33, _anon_PERCENT_2_34) {
        return (_anon_PERCENT_1_33 + _anon_PERCENT_2_34);
    }), 0, _PLUS_.fmap((function(_anon_PERCENT_1_32) {
        return scratchCardsWonById(_anon_PERCENT_1_32, cardsById44);
