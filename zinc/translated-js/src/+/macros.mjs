...
return implement_flatplicative(type_id, (function (_anon_PERCENT_1_87) {
if ((type_id === _anon_PERCENT_1_87["T"])) {
return _anon_PERCENT_1_87;} else {
return pure(type_id, _anon_PERCENT_1_87);}
}));
})
;
