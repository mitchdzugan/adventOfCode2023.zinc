import * as _PLUS_ from './raw-js.mjs';export * from './raw-js.mjs';
...
return implement_flatplicative(type_id, (function (_anon_PERCENT_1_101) {
if ((type_id === _anon_PERCENT_1_101["T"])) {
return _anon_PERCENT_1_101;} else {
return pure(type_id, _anon_PERCENT_1_101);}
}));
})
;
...
return a;} else {
if ("else") {
return mplus(a, b_flat2);} else {
return undefined;}}}
})
;

export { mzero, mk_inst_id, implement_flatplicative_for_applicative, mplus, qt_store, pure, ensure_type, prop_store, mk_id_generator, variant_store, flatplicative_impls, implement_monad_plus, implement_flatplicative, set_qt_store, implement_applicative, monad_plus_impls, applicative_impls, fplus }
