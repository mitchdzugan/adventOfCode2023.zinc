...
return 0;
}), (function (_anon_PERCENT_1_60, _anon_PERCENT_2_61) {
return (_anon_PERCENT_1_60 + _anon_PERCENT_2_61);
}));
...
return false;
}), (function (_anon_PERCENT_1_62, _anon_PERCENT_2_63) {
return (_anon_PERCENT_1_62 || _anon_PERCENT_2_63);
}));
_PLUS_.implement_monad_plus(_PLUS_.VecT, (function () {
return Vec();
}), (function (_anon_PERCENT_1_64, _anon_PERCENT_2_65) {
return concat(_anon_PERCENT_1_64, _anon_PERCENT_2_65);
}));
_PLUS_.implement_monad_plus(_PLUS_.MaybeT, (function () {
return None;
}), (function (_anon_PERCENT_1_67, _anon_PERCENT_2_66) {
return maybe(_anon_PERCENT_2_66, Just, _anon_PERCENT_1_67);
}));
_PLUS_.implement_applicative(_PLUS_.VecT, (function (_anon_PERCENT_1_68) {
return Vec(_anon_PERCENT_1_68);
}));
_PLUS_.implement_applicative(_PLUS_.MaybeT, (function (_anon_PERCENT_1_69) {
return Just(_anon_PERCENT_1_69);
}));
...
_PLUS_.implement_flatplicative(_PLUS_.BoolT, (function (_anon_PERCENT_1_70) {
return _PLUS_.not(_PLUS_.not(_anon_PERCENT_1_70));
}));
...
initials24.forEach((function (_anon_PERCENT_1_71) {
return d25.set(key(_anon_PERCENT_1_71), _anon_PERCENT_1_71);
}));
return ({ "T": _PLUS_.SetT, "I": id26, get "J"(){ let $_927 = this;
return _PLUS_.js_array_from(d25, [_PLUS_.SetT], (function (p__28) {
let vec__2932 = p__28;
let _33 = vec__2932[0];
let v34 = vec__2932[1];
return json(v34);
}));}, get "P"(){ let $_1035 = this;
return pretty(vals(d25));}, "d": d25 });
});
...
let empty_QMARK_91 = (function (_anon_PERCENT_1_72) {
return _PLUS_.is(0, _PLUS_.js_length(_anon_PERCENT_1_72));
});
let G__9293 = kl63;
G__9293;
...
return ({ "T": _PLUS_.MaybeT, "I": id182, get "J"(){ let $_16183 = this;
if (e) {
return [_PLUS_.MaybeT, _PLUS_.null$];} else {
return [_PLUS_.MaybeT, json(j)];}}, get "P"(){ let $_17184 = this;
if (e) {
...
return _PLUS_.apply(Vec, Array.from(Array(_PLUS_.ceil(_PLUS_.div((end - init), step))), (function (_anon_PERCENT_1_74, _anon_PERCENT_2_73) {
return (init + (step * _anon_PERCENT_2_73));
})));
});
if (_PLUS_.nil_QMARK_(a1198)) {
return Vec();} else {
if (_PLUS_.nil_QMARK_(a2199)) {
return fin201(0, a1198, (((a1198 >= 0)) ? (1) : (-1)));} else {
if (_PLUS_.nil_QMARK_(a3200)) {
return fin201(a1198, a2199, (((a2199 >= a1198)) ? (1) : (-1)));} else {
if ("else") {
return fin201(a1198, a2199, a3200);} else {
return undefined;}}}}
});
...
return fmap((function (_anon_PERCENT_1_75) {
return _anon_PERCENT_1_75[0];
}), Maybe($203["d"][k]));
...
return _PLUS_.apply(Set, filter((function (_anon_PERCENT_1_76) {
return has_QMARK_(s2, _anon_PERCENT_1_76);
}), vals(s1))["a"]);
})
;
...
})).forEach((function (_anon_PERCENT_1_77) {
return _anon_PERCENT_1_77();
}));
})
;
...
let $213 = val_3;
return coll_impl(({ [_PLUS_.VecT]: (function () {
return $213["a"]["forEach"]((function (_anon_PERCENT_1_78, _anon_PERCENT_2_79) {
return f(_anon_PERCENT_1_78, _anon_PERCENT_2_79, $213);
}));
}), [_PLUS_.MapT]: (function () {
return for_each_map(f, $213, _PLUS_.id, _PLUS_.id);
}), [_PLUS_.KeyMapT]: (function () {
return for_each_map(f, $213, (function (_anon_PERCENT_1_80) {
return _anon_PERCENT_1_80["vs"];
}), (function (_anon_PERCENT_1_81) {
return $213["ks"]["get"](_anon_PERCENT_1_81);
}));
}), [_PLUS_.MaybeT]: (function () {
if ($213["e"]) {
...
return $213["a"].forEach().fn([[id, v], ind], f(v, id, $213, ind))();
}) }), $213);
})
;
var reduce = (function (f, init, coll) {
let res214 = [init];
each((function (_anon_PERCENT_1_82, _anon_PERCENT_2_83, _anon_PERCENT_3_84, _anon_PERCENT_4_85) {
return res214[0] = f(res214[0], _anon_PERCENT_1_82, _anon_PERCENT_2_83, _anon_PERCENT_3_84, _anon_PERCENT_4_85);
}), coll);
return res214[0];
})
;
...
let $215 = val_4;
return coll_impl(({ [_PLUS_.VecT]: (function () {
return _PLUS_.apply(Vec, $215["a"]["map"]((function (_anon_PERCENT_1_86, _anon_PERCENT_2_87) {
return f(_anon_PERCENT_1_86, _anon_PERCENT_2_87, $215);
})));
}), [_PLUS_.MapT]: (function () {
...
let $223 = val_5;
return coll_impl(({ [_PLUS_.VecT]: (function () {
return _PLUS_.apply(Vec, $223["a"]["flatMap"]((function (_anon_PERCENT_1_88, _anon_PERCENT_2_89) {
return f(_anon_PERCENT_1_88, _anon_PERCENT_2_89, $223)["a"];
})));
}), [_PLUS_.MaybeT]: (function () {
if ($223["e"]) {
return $223;} else {
...
let $224 = val_6;
return coll_impl(({ [_PLUS_.VecT]: (function () {
return _PLUS_.apply(Vec, $224["a"]["filter"]((function (_anon_PERCENT_1_90, _anon_PERCENT_2_91) {
return p(_anon_PERCENT_1_90, _anon_PERCENT_2_91, $224);
})));
}), [_PLUS_.MaybeT]: (function () {
...
return filter((function (_anon_PERCENT_1_92, _anon_PERCENT_2_93, _anon_PERCENT_3_94) {
return _PLUS_.not(p(_anon_PERCENT_1_92, _anon_PERCENT_2_93, _anon_PERCENT_3_94));
}), coll);
})
;
...
return _PLUS_.apply(Vec, _PLUS_.js_array_from($225, (function (_anon_PERCENT_1_95) {
return _anon_PERCENT_1_95[0];
})));
}), [_PLUS_.SetT]: (function () {
return vals($225["d"]);
}), [_PLUS_.KeyMapT]: (function () {
...
return _PLUS_.apply(Vec, _PLUS_.js_array_from($226, (function (_anon_PERCENT_1_96) {
return _anon_PERCENT_1_96[1];
})));
}), [_PLUS_.SetT]: (function () {
return vals($226["d"]);
}), [_PLUS_.KeyMapT]: (function () {
...
((_PLUS_.nil_QMARK_(pid238)) ? ((function (_anon_PERCENT_1_97) {
return _anon_PERCENT_1_97["f"] = pid238;
})) : ((function (_anon_PERCENT_1_98) {
return _anon_PERCENT_1_98["d"][pid238][2] = id232;
})))(G__239240);
G__239240[_anon_PERCENT_1_99]["d"][target_id][1] = id232;
G__239240[_anon_PERCENT_1_99]["d"][id232] = [v, pid238, target_id];
G__239240;
return Just(id232);}
}) }), $230);
})
...
let $241 = val_13;
return coll_impl(({ [_PLUS_.VecT]: (function () {
return $241["a"].unshift(v);
}), [_PLUS_.SetT]: (function () {
return $241["d"].set(key(v), v);
}), [_PLUS_.KeyedListT]: (function () {
return insert($241, $241["f"], v);
}) }), $241);
})
;
...
let $242 = val_14;
return coll_impl(({ [_PLUS_.VecT]: (function () {
let res243 = _PLUS_.apply(Vec, $242["a"]);
res243["a"].sort();
return res243;
}) }), $242);
})
...
let res244 = Map();
each((function (_anon_PERCENT_1_100) {
return put(res244, f(_anon_PERCENT_1_100), _anon_PERCENT_1_100);
}), c);
return res244;
})
;
...
let unjson_pairs245 = (function (p__246) {
let vec__247250 = p__246;
let k251 = vec__247250[0];
let v252 = vec__247250[1];
return [unjson(k251), unjson(v252)];
});
...
return Map(unjson_pairs245.map(v.slice(1)));
}), [_PLUS_.KeyMapT]: (function () {
return KeyMap(unjson_pairs245.map(v.slice(1)));
}) })[type_id(v)] || (function () {
return v.map(unjson);
}))();} else {
...
export { json, unjson, Unit, or_, implement_key, keys, Vec, maybe, put, Map, KeyedList, empty_QMARK_, bind, decode, key, union, KeyMap, Just, for_each_map, forcedKey, sort, MapClass, maybe_, pretty, None, unshift, Range, keyBy, vals, or, inst_id, remove, concat, filter, intersection, each, fmap, insert, size, reduce, encode, type_id, at, Maybe, Set, has_QMARK_ }
